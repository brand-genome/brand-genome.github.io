...
- Details about logo configurations, versions, and specific applications are found across multiple pages—e.g., construction guidelines, use over backgrounds, area of reserve, and anniversary-specific variants.

**Color Information:**

- The brand's official color palette includes the primary colors Pantone 540C (Blue) and Pantone 130C (Yellow), while grayscale variants are defined for monochromatic use along with secondary tones.

**Typography Information:**

- The main typography for the logo includes the Baufra DemiBold for a geometric yet humanistic design and Futura Lt BT as a secondary typeface.
- A dedicated Desyrel typeface is mandated exclusively for the UniSalle logo, offering an organic and youthful design.
- The University’s 50th anniversary design employs dual typefaces: New Facebook for the numeric '50' and Baufra for the label 'AÑOS.'
- Complementary typefaces such as Helvetica Neue Lt Std (with weights like light, condensed, bold) are specified for institutional materials like posters and documentation.

**Imagery Photography:**

- The introduction emphasizes framing brand visuals for coherence, with human-centered themes around integrity, educational transformation, and thinking socially.

**Spacing Layout:**

- Spacing and proportions include a reserved area defined by a letter unit of 'X,' ensuring logo integrity across contexts such as co-branding or scaling.

**Brand Voice:**

- The brand communicates with a tone of inclusivity, commitment toward country transformation, and expressions like the call to action 'Sé real, piensa social.'
