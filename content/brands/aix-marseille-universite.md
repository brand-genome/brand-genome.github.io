...
description: ""
date: "2026-04-16T19:21:57.700166"
draft: false
sectors:
  - university
regions:
...
- Garantir la cohérence de l'identité visuelle d'Aix Marseille Université et fournir un outil pratique pour la création des supports de communication de l'université [^1].
...
- Personnels, étudiants, partenaires institutionnels, publics internes et externes de l'université [^2].
...
- Identité visuelle centrée sur le logotype amU, une typographie exclusive (AMU Monument Grotesk), une palette de couleurs principale (bleu, jaune, blanc, noir), des déclinaisons sectorielles, une iconographie professionnelle, des formes géométriques variées, et des règles strictes d'utilisation pour garantir cohérence et lisibilité [^3].

#### Categories

##### Brand Imagery

- L’université dispose d’une photothèque, enrichie au fil des ans par des photographes professionnels. Elle valorise l’établissement, ses infrastructures et ses usagers, sur l’ensemble de ses campus et illustre les différentes missions de l’université.
- Ces photographies ne sont pas en accès libre, mais certaines peuvent être transmises sur simple demande auprès de la direction de la communication. L’usage des photographies amU est soumis aux droits d’auteur. Pour toute utilisation, une demande écrite doit être faite en amont à la direction de la communication : dircom-contact@univ-amu.fr
- Pour toute photographie diffusée dans un cadre hors amU par un personnel ou un étudiant de l’université ou par un extérieur, le copyright suivant doit être impérativement mentionné : © amU — Aix Marseille Université.
- amU dispose de nombreux bâtiments et campus, deux typologies de photo peuvent être définis pour les représenter : Des vues de l’extérieur des bâtiments, dans lesquelles on retrouve des jeux de perspective et de lumière créés avec l’architecture. Des vues de l’intérieur, les compositions photographiques peuvent se faire avec l’alignement des sièges d’un amphithéâtre, la répétition des allées des bibliothèques, la perspective des escaliers ou des bureaux.
- Un des atouts amU est son environnement de travail. Il ne faut pas hésiter à communiquer sur les alentours des différents campus afin d’illustrer la nouvelle baseline Explorer pour faire société.
- Des vues larges du paysage méditerranéen à différentes heures de la journée et avec différentes météos (pour illustrer une réalité, autre que les clichés).
- Des images prises depuis des bâtiments avec une ouverture sur l’extérieur. Créant ainsi des fenêtres sur les paysages avec un jeu de premier et second plan.
- amU propose de nombreuses formations différentes, il est important de les représenter à leur juste valeur. Les photographies sont prises pendant des instants de travail. Elles doivent paraître le moins posées possible. Si le contexte le permet, on peut montrer l’environnement de travail avec des jeux de perspective et différents plans.
- Il faut absolument éviter les photos pas naturelles de banque d’image.
- Pour représenter les étudiants amU. Deux typologies de photographie sont recommandées : Soit faire poser les étudiants lors d’un shooting. Mais sans fausse mise en scène. Ou soit en représentant la vie étudiante en les prenant en photo sur le vif lors d’activités, cette fois-ci, ils ne devront pas poser.
- Il est possible d’utiliser des illustrations pour certains événements. Il est important de les traiter comme des images et non comme des extraits afin de faciliter la mise en page avec les blocs.
- Certaines images, de par leur mauvaise qualité ou pour des raisons esthétiques, peuvent nécessiter un traitement graphique. Deux méthodes peuvent être utilisées : Soit l’image se réfère à l’un des secteurs d’activité amU. Dans ce cas le traitement graphique est une bichromie réalisé avec les couleurs de la gamme tertiaires du secteur d’activité. Soit le visuel global est générique, et dans ce cas la bichromie se fait avec les couleurs de la gamme principales, bleu et blanc ou jaune et noir.

##### Color Palette

- Dans la continuité de l’ancienne identité, le bleu et le jaune sont les couleurs principales de l’identité amU.
- Le bleu symbolise le ciel du sud et surtout de la mer méditerranée. Le jaune symbolise lui le soleil et plus généralement la lumière de la région.
- Il n’est pas conseillé d’utiliser le jaune et le bleu ensemble mais plutôt d’associer le bleu et le blanc ou le jaune et le noir.
- Bleu Pantone : 285C CMJN : 90 48 0 0 RVB : 30 100 222 Web : #1F63DE
- Blanc CMJN : 0 0 0 0 RVB : 255 255 255 Web : #FFFFFF
- Jaune Pantone : 903C CMJN : 0 0 60 0 RVB : 255 255 133 Web : #FFFF85
- Noir CMJN : 0 0 0 100 RVB : 0 0 0 Web : #000000
- Jaune or Pantone : 109C CMJN : 0 10 100 0 RVB : 254 209 0 Web : #FED100
- Orange Pantone : 151C CMJN : 0 64 100 0 RVB : 255 121 0 Web : #FF7900
- Vert Pantone : 3395C CMJN : 61 0 55 0 RVB : 83 222 148 Web : #53DE94
- Corail Pantone : 170C CMJN : 0 50 48 0 RVB : 255 139 124 Web : #FF8B7C
- Bleu Pantone : 306C CMJN : 76 0 5 0 RVB : 51 204 255 Web : #33CCFF
- Mauve Pantone : 265C CMJN : 55 68 0 0 RVB : 153 102 255 Web : #9966ff
- Jaune pâle Pantone : 9121C CMJN : 0 0 33 0 RVB : 255 255 191 Web : #FFFFBF
- Ocre Pantone : 132C CMJN : 25 42 97 16 RVB : 178 209 27 Web : #B2861B
- Orange clair Pantone : 712C CMJN : 0 17 27 0 RVB : 255 222 191 Web : #FFDEBF
- Brique Pantone : 1525C CMJN : 23 70 100 14 RVB : 178 86 0 Web : #B25600
- Vert clair Pantone : 331C CMJN : 24 0 20 0 RVB : 202 254 228 Web : #CAFEE4
- Vert émeraude Pantone : 335C CMJN : 82 13 66 0 RVB : 0 154 116 Web : #009A74
- Corail pâle Pantone : 169C CMJN : 0 24 17 0 RVB : 255 212 204 Web : #FFD4CC
- Rouge vin Pantone : 187C CMJN : 25 100 100 26 RVB : 153 0 0 Web : #990000
- Pantone : 290C CMJN : 23 0 0 0 RVB : 205 234 252 Web : #CDEAFC
- Bleu Roi Pantone : 296C CMJN : 100 92 22 8 RVB : 0 0 142 Web : #00008E
- Lavande Pantone : 263C CMJN : 17 23 0 0 RVB : 221 204 255 Web : #DDCCFF
- Violet Pantone : 267C CMJN : 80 100 0 0 RVB : 102 0 153 Web : #660099

##### Typography

- L’identité amU repose sur l’utilisation exclusive de la police AMU Monument Grotesk distribuée par la fonderie DINAMO. Ce caractère doit son point de départ à quelques contours intriguants découverts par le studio Kasper-Florio lors de la numérisation du livre New Specimen Book de la fonderie Palmer & Rey (1884). Poussé par le squelette compact des lettres, le fort contraste vertical et des terminaisons étonnamment nets, Kasper-Florio a numérisé et réinterprété la police de caractères pour un usage contemporain. AMU Monument Grotesk est une police très lisible et institutionnelle mais offre des formes brutes et agréablement non polies.
- AMU Monument Grotesk Regular
- Nous utiliserons 6 variantes de cette typographie : • Regular • Regular Italic • Medium • Medium Italic • Bold • Bold Italic
- Il faudra privilégier le Regular pour le texte courant ainsi que les titres et travailler la hiérarchisation par les différences de taille. Le Medium pourra également être utilisé pour des titres, des sous-titres ou des mises en exergues. Le bold sérvira essentiellement à mettre en avant un mot ou une phrase dans un texte.
- Lorsque « AMU Monument Grotesk » ne peut pas être utilisée, nous préconnisont l’utilisation de la police « Arial ».
- Il ne faut pas écrire de titres, de mots ou de paragraphes entièrement en capitales.
- Le texte devra être systématiquement férré à gauche. Les compositions centrées férrées à droite ou justifiées sont à éviter.
- Nous préconisons d’employer trois corps de texte différents dans un même document graphique. Ici un exemple de trois tailles de typo.
- Corps 1 40pt
- Corps 2 20pt
- Corps 3 10pt
...
- Le nouveau logotype amU est composé de deux éléments : • L’acronyme, traité de manière singulière, avec sa capitale en fin de mot pour mettre l’accent sur l’institution. • L’intitulé, chaque mot vient se placer sous les lettres qu’il explicite.
- Un espace de protection doit être respecté autour du logo afin de ne pas géner sa lisibilité.
- Il faut utiliser l’espace entre le « m » et le « U » pour définir la zone de dégagement tout autour du logo.
- La taille minimale d’utilisation du logo est de 35 mm en largeur ou 100 px. Au delà de cette taille c’est le logotype partenaire qu’il conviendra de choisir.
- Lorsqu’il est utilisé sur un fond coloré ou sur une image, il convient d’utiliser cette version du logo. Il permet une bonne visibilité et accentue la force du signe typographique.
- Il est possible de l’utiliser dans différentes déclinaisons colorées.

##### Visual Style

- Le nouveau logotype amU est composé de deux éléments : • L’acronyme, traité de manière singulière, avec sa capitale en fin de mot pour mettre l’accent sur l’institution. • L’intitulé, chaque mot vient se placer sous les lettres qu’il explicite.
- Un espace de protection doit être respecté autour du logo afin de ne pas géner sa lisibilité. Il faut utiliser l’espace entre le « m » et le « U » pour définir la zone de dégagement tout autour du logo.
- La taille minimale d’utilisation du logo est de 35 mm en largeur ou 100 px. Au delà de cette taille c’est le logotype partenaire qu’il conviendra de choisir.
- Lorsqu’il est utilisé sur un fond coloré ou sur une image, il convient d’utiliser cette version du logo. Il permet une bonne visibilité et accentue la force du signe typographique. Il est possible de l’utiliser dans différentes déclinaisons colorées.
...
- ● Utiliser le logo de l’université pour tous les services et initiatives étroitement liés à la mission principale de l’institution (services dédiés aux personnels et à la vie étudiante, orientation, formation etc) ou dont le public cible est majoritairement interne (personnels et étudiants). Cela renforce la confiance vis-à-vis du service, l’unité et la cohérence de l’image de marque amU.
- ● Création d’un Logo distinct : La création d’un logo distinct est possible pour des services qui ont des objectifs ou des publics très différents, et qui nécessitent une identité forte pour se différencier au sein de leur écosystème (ex : DIRFOR, MEDIAM).
- Dans les deux cas, la communication émise par les services ou directions doit pleinement s’inscrire dans la charte graphique d’Aix-Marseille Université, qui est l’unique identité visuelle de l’université.
- La décision de créer un logo doit être fondée sur une analyse approfondie des objectifs, de l’image de marque et du public cible par la DIRCOM. Une évaluation de ces éléments permettra de déterminer si un logo distinct est justifié ou si l’utilisation du logo de l’université est plus appropriée.

##### Co Branding

- Lorsqu’il est utilisé en dessous de 35 mm ou utilisé avec d’autres logos, c’est cette version du logotype qu’il faut utiliser afin d’optimiser la lecture de l’intitulé.
- Assurez-vous qu’il y ait au minimum la largeur d’un « U » avant et après le logo.
- Pour les composantes s’inscrivant dans un réseau national, il faut utiliser le logo du réseau national, un séparateur puis le logo amU partenaire.

##### Print Guidelines

- Des modèles d'affiches sont disponibles au téléchargement. Ils vont du A0 au A6 aux formats verticaux et horizontaux. Ces modèles serviront de base à la mise en page mais la créativité autour de ce cadre est évidement encouragée.
- Le Président Monsieur Prénom Nom Nom du bâtiment 163 avenue Luminy 13009 Marseille Marseille, le mardi 9 mai 2023 Madame, Monsieur, Contrairement à une opinion répandue, le Lorem Ipsum n’est pas simplement du texte aléatoire. Il trouve ses racines dans une oeuvre de la littérature latine classique datant de 45 av. J.-C., le rendant vieux de 2000 ans. Un professeur du Hampden-Sydney College, en Virginie, s’est intéressé à un des mots latins les plus obscurs, consectetur, extrait d’un passage du Lorem Ipsum, et en étudiant tous les usages de ce mot dans la littérature classique, découvrit la source incontestable du Lorem Ipsum. Plusieurs variations de Lorem Ipsum peuvent être trouvées ici ou là, mais la majeure partie d’entre elles a été altérée par l’addition d’humour ou de mots aléatoires qui ne ressemblent pas une seconde à du texte standard. Si vous voulez utiliser un passage du Lorem Ipsum, vous devez être sûr qu’il n’y a rien d’embarrassant caché dans le texte. Tous les générateurs de Lorem Ipsum sur Internet tendent à reproduire le même extrait sans fin, ce qui fait de lipsum.com le seul vrai générateur de Lorem Ipsum. Iil utilise un dictionnaire de plus de 200 mots latins, en combinaison de plusieurs structures de phrases, pour générer un Lorem Ipsum irréprochable. Le Lorem Ipsum ainsi obtenu ne contient aucune répétition, ni ne contient des mots farfelus, ou des touches d’humour. Bien cordialement, Signature Nom Prénom Fonction Jardin du Pharo 58 boulevard Charles Livon 13284 Marseille T +33 (0)4 91 39 65 01 F +33 (0)4 91 52 91 03 M prenom.nom@univ-amu.fr Jardin du Pharo T M prenom.nom@univ-amu.fr cedex 07 ˜ France W www.univ-amu.fr 58 boulevard Charles Livon F +33 (0)4 91 39 65 01 +33 (0)4 91 52 91 03 W www.univ-amu.fr 13284 Marseille cedex 07 ° France Nom Prénom Fonction Jardin du Pharo T +33 (0)4 91 39 65 01 M prenom.nom@univ-amu.fr Jardin du Pharo 58 boulevard Charles Livon F +33 (0)4 91 52 91 03 W www.univ-amu.fr 58 boulevard Charles Livon 13284 Marseille cedex 07 ˜ France 13284 Marseille cedex 07 ˜ France T +33 (0)4 91 39 65 01 F +33 (0)4 91 52 91 03 M yvon.berland@univ-amu.fr W www.univ-amu.fr
- 6.C. Plaquette ↗

##### Digital Guidelines

- La taille minimale d’utilisation du logo est de 35 mm en largeur ou 100 px. Au delà de cette taille c’est le logotype partenaire qu’il conviendra de choisir.
- Ces logotypes sont déclinés dans différents formats et espaces colorimétrique pour deux usages distincts : • Imprimé — Formats .ai et .eps en CMJN • Écran — Formats .png et .svg en RVB

##### Social Media Guidelines

- Des modèles pour créer du contenu pour les réseaux sociaux sont disponibles en téléchargement :
- L'image de profil du compte principal de l'Université est l’acronyme sur fond jaune. Les différents services utiliseront l’acronyme sur fond bleu .
- Les composantes pourront choisir entre leur acronyme et leur signe lorsqu'il existe.
- Les composantes faisant partie d'un réseau national utiliseront une version simplifiée de leur logo.
- Les instituts pourront choisir entre leur acronyme et leur signe.
- Pour les posts récurrents, une série d’intitulés est disponible. Il est possible de générer d’autres intitulés et d'en modifier la couleur.
- Quand deux sujets se suivent dans une storie Instagram, il est nécéssaire de changer de couleur pour séparer les informations.
- Un outil incluant la gamme colorée est disponible pour faciliter les changements de fond des stories.
...
- Aix-Marseille Université aims to foster a unified identity, promote excellence, and ensure that all members feel part of the institution, identify with it, and are proud to represent its colors. The systematic and rigorous application of its visual identity is essential to maintain brand coherence and image [^1].
...
- Personnel, students, partners, and service providers of Aix-Marseille Université, as well as the broader academic and professional community [^2].
...
- The visual identity is defined by a typographic logo combining the names 'Aix' and 'Marseille' with an asterisk and an open parenthesis symbolizing unity and openness. The color palette includes blue, yellow, black, and white, with strict rules for logo usage, proportions, and protection zones. Official typography is Klavika Basic, with Verdana and Titillium as substitutes. The visual style is minimalist, geometric, and consistent across all materials, including papeterie, seals, digital templates, and sector-specific color codes [^3].

#### Categories

##### Brand Imagery

- La zone de protection est le blanc tournant du logotype : cela le protège des éléments avoisinants afin qu’ils ne viennent pas perturber sa lisibilité (notamment lorsque plusieurs logos sont positionnés côte à côte). Cette zone est égale à 1/4 de la hauteur de la parenthèse. En revanche, il faut éviter d’enfermer le logo dans un cartouche, on préfèrera un bandeau de la largeur du support, mais si cela est impossible à éviter, on prendra soin de dimensionner le cartouche à minima à la taille de cette zone de protection.
- Les différents éléments composant le logo ne peuvent pas être modifiés indépendamment les uns des autres, que ce soit en terme de dimension, de position, de couleur ou d’effet.
- Les proportions du logotype sont définies une fois pour toutes. Lors de l’ajustement du logotype, il faut veiller à ce que le rapport entre la largeur et la hauteur soit toujours maintenu de manière homothétique.
- Une taille minimale a été arrêtée, en deçà de laquelle la lisibilité du logotype serait altérée : la hauteur du logotype (définie par la hauteur de la parenthèse) ne doit pas être inférieure à 6 mm (soit environ 17,5 mm de large).
- Le logotype doit toujours être représenté dans sa position horizontale. Une exception est toutefois tolérée en regard du support, par exemple sur le dos d’un volume, ou sur un drapeau vertical représentant uniquement le logotype. Dans ce cas le logotype subira une rotation à 90° dans le sens inverse des aiguilles d’une montre, de telle sorte qu’il soit lisible du bas vers le haut.

##### Color Palette

- Les couleurs du logotypes sont définies pour chaque mode colorimétrique (Pantone et CMJN pour l’impression, RVB et héxadécimales pour un usage sur écran) et sont non modifiable. Selon l’usage, un fichier adapté peut être fourni.
- Jaune Pantone 130 C, RVB 240, 171, 0, CMJN 0, 30, 100, 0, Hexadécimal #FFCC00
- Bleu roi Pantone 300 C, RVB 0, 101, 189, CMJN 100, 44, 0, 0, Hexadécimal #0066CC
- Cyan Pantone 298 C, RVB 61, 183, 228, CMJN 70, 0, 0, 0, Hexadécimal #00CCFF
- Noir Pantone Process Black C, RVB 0, 0, 0, CMJN 0, 0, 0, 100, Hexadécimal #000000
- Blanc Pantone White, RVB 255, 255, 255, Hexadécimal #ffffff
- Interdiction de modifier les couleurs du logo
- L’utilisation du logo en couleur est à privilégier sur fond blanc. À défaut on respectera les recommandations suivantes : En couleur sur fond très clair (densité inférieur à 10%). En noir sur fond clair (densité inférieure à 35%). En réserve sur fond foncé (densité supérieure à 35%).
- D’une manière générale, on veillera à la bonne lisibilité du logo : sur une photo perturbée, il faudra le placer sur une zone peu contrastée, à défaut on le placera dans un cartouche respectant à minima sa zone de protection.
- Chaque composante fait partie de l’un des 6 grands secteurs. Ces secteurs sont indentifiables selon un code couleur dont la composition colorimétrique est définie ci-dessous. Il importe que chaque composante respecte la couleur de son secteur pour une image de marque plus forte de l’université.
- La couleur 1 est la couleur dominante, accompagnée de la couleur secondaire 2, elles définissent ensemble la couleur du secteur. La couleur 3 est une couleur d’accompagnement prédéfinie des deux premières, et peut être complété d’autres couleurs propres à chaque composante, dans le respect de la couleur de secteur, et de sorte que l’ensemble soit harmonieux.
- Secteur arts, lettres, langues et sciences humaines : Couleur 1 Pantone 137 C, RVB 255, 161, 0, CMJN 0, 40, 100, 0, Hexadécimal #FFA100; Couleur 2 Pantone 1655 C, RVB 251, 79, 20, CMJN 0, 70, 95, 0, Hexadécimal #FB4F14; Couleur 3 Pantone 7406 C, RVB 235, 183, 0, CMJN 0, 20, 100, 0, Hexadécimal #EBB700
- Secteur droit et sciences politiques / Secteur économie et gestion : Couleur 1 Pantone 711 C, RVB 207, 47, 68, CMJN 0, 97, 73, 0, Hexadécimal #CF2F44; Couleur 2 Pantone 1805 C, RVB 170, 39, 47, CMJN 23, 100, 87, 29, Hexadécimal #AA2F2F; Couleur 3 Pantone 7427 C, RVB 150, 23, 46, CMJN 0, 100, 74, 23, Hexadécimal #96172E
- Secteur sciences et technologies : Couleur 1 Pantone 646 C, RVB 84, 130, 171, CMJN 80, 30, 0, 20, Hexadécimal #5482AB; Couleur 2 Pantone 7462 C, RVB 0, 90, 139, CMJN 80, 42, 0, 46, Hexadécimal #005A8B; Couleur 3 Pantone 3125 C, RVB 0, 176, 202, CMJN 80, 0, 20, 0, Hexadécimal #00B0CA
- Secteur santé : Couleur 1 Pantone 360 C, RVB 97, 194, 80, CMJN 70, 0, 80, 0, Hexadécimal #61C250; Couleur 2 Pantone 349 C, RVB 0, 105, 60, CMJN 90, 25, 100, 30, Hexadécimal #00693C; Couleur 3 Pantone 367 C, RVB 165, 216, 103, CMJN 42, 0, 75, 0, Hexadécimal #A5D867
- Secteur pluridisciplinaire : Couleur 1 Ref. Blue C, RVB 0, 35, 149, CMJN 100, 91, 0, 0, Hexadécimal #002395; Couleur 2 Pantone 2748 C, RVB 3, 31, 115, CMJN 100, 95, 5, 19, Hexadécimal #031F73; Couleur 3 Pantone 3262 C, RVB 0, 192, 181, CMJN 80, 0, 35, 0, Hexadécimal #00C0B5
