...
slug: harmony
description: ""
date: "2026-03-20T08:22:04.556303"
draft: false
sectors:
  - software
  - "blockchain-crypto"
...
- Logo Variations: Details provided about horizontal, vertical, and icon-only designs.
- Logo Scalability and clear space/safe zone rules.
- Dos and Don'ts for logo usage including incorrect examples.

**Color Information:**

- Primary colors are defined for both screen and print: RGB/HEX, CMYK, PMS color guides.
- Gradient color guide for secondary accents.

**Typography Information:**

- Font families and typography usage across headlines, body text, and UI elements.

**Imagery Photography:**

- Imagery guidelines include photography styles and appropriate use cases.

**Spacing Layout:**

- Spacing and layout grids to maintain consistency in design application.

**Brand Voice:**

- Voice & Tone: Harmonious, inclusive, and innovative communication style.
- Key phrases for messaging consistency.
