...
| Freebase Id | /m/09d6g |
| Programmed In |  |
| Stack Exchange Tag | https://stackoverflow.com/tags/cvs |
| Copyright License | GNU General Public License, version 1.0 or later |
| Inception | 1990-11-19 |
| Source Code Repository Url | https://savannah.nongnu.org/projects/cvs |
| File Format Wiki Page Id | Concurrent_Versions_System |
| Gnd Id | 4597700-8 |
| Operating System | Unix-like operating system |
| Arch Linux Package | cvs |
| Uniform Resource Identifier Scheme | cvs |
| Software Version Identifier | 1.11.23, 1.11.22, 1.11.21, 1.12.13 |
| Open Hub Id | cvs |
| Developer | The CVS Team |
| Gentoo Package | dev-vcs/cvs |
| Debian Stable Package | cvs |
| Pro Linux.De Dbapp Id | 3384 |
| Fedora Package | cvs |
| Repology Project Name | cvs |
| Short Name | CVS |
| Freebsd Port | devel/cvs-devel, devel/cvs |
| Has Use | version control |
| Netbsd Package Id | devel/scmcvs |
| Has Part(S) | pserver |
| Homebrew Formula Name | cvs |
| Publication Date | 1990-11-19 |
| Bibliothèque Nationale De France Id | 135668548 |
| Viaf Cluster Id | 179955429 |
| Library Of Congress Authority Id | n99833687 |
| Canadiana Name Authority Id | ncf10779390 |
| Debian Source Package | cvs |
| Free Software Directory Entry | cvs |
| Issue Tracker Url | https://savannah.nongnu.org/bugs/?group=cvs |
| Idref Id | 052592642 |
| Mailing List Archive Url | https://lists.nongnu.org/archive/html/cvs-dev/, https://lists.nongnu.org/archive/html/info-cvs/, https://lists.nongnu.org/archive/html/bug-cvs/ |
| Copyright Status | copyrighted |
| Guix Variable Name | cvs |
| Ubuntu Package | cvs |
| Alternativeto Software Id | cvs |
| National Library Of Israel J9U Id | 987009950843105171 |
| Pronunciation Audio | LL-Q9288 (heb)-Uziel302-CVS.wav |
| Maintained By | Derek Robert Price |
| Chocolatey Community Package Id | cvs |
| Gentoo Wiki Article | CVS |
| Archwiki Article | Concurrent_Versions_System |
| Foldoc Id | CVS |
| De Agostini Id | CVS |
| ‎Computerlanguage.Com Definition | CVS |
