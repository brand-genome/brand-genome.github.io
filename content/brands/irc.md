...
- IRC brand guidelines cover logo specifications, including different versions, proper placement, proportions, and rebranding updates.
- Clear guidelines on safe zones and respect for clear space around the IRC logo for better visibility. Measurements use the 'X' height concept.
- Minimum size recommendations for the IRC logo outlined clearly for print and digital usage.
- Incorrect usage examples of the IRC logo. These include stretching, compressing, or changing colors inappropriately.
- Logo color applications include full-color, black-and-white, and reversed versions for different background scenarios.
- Different orientations of the IRC logo, such as horizontal and vertical layouts, illustrated and discussed.
- Specific details on using the IRC wordmark and logo icon either as standalone or combined elements.
- Reversed logo variations to ensure visibility on darker backgrounds.
- File formats mentioned include RGB use cases for digital screens and EPS for scalable print materials.

**Color Information:**

- Primary brand colors outlined, including yellow as Hex: #FFD635 and Pantone Yellow C. Yellow is the cornerstone of the IRC visual identity.
- Secondary and tertiary color palettes provided to complement the primary color scheme. RGB, CMYK, and HEX values are outlined.
- Specific rules for combining or pairing colors to maintain brand consistency across different design accesses.

**Typography Information:**

- Primary typefaces specified: Helvetica Neue for headers and Arial for body text. Weights include Light, Regular, and Bold.
- Font sizes and proportional spacing are standardized for a cohesive look across materials.
- Typography hierarchy explained for establishing visual emphasis: headlines vs body vs captions.

**Imagery Photography:**

- Photography style should balance vibrancy and authenticity, reflecting the organization's mission.
- Guidelines for image composition focus on storytelling and inclusive representation.

**Spacing Layout:**

- Grid system used as the foundation for designing layouts with harmony and consistency.
- Margin and padding rules described to prevent overcrowding and ensure design clarity.

**Brand Voice:**

- IRC's tone of voice is described as confident, authoritative, and approachable.
- Messaging do's include clear, action-oriented language aligned with the organization's mission.
- Key tagline: 'Driving positive disruption in the water, sanitation, and hygiene sector.'

**Notes:**

- This brand guideline is version 1, published in November 2013, following rebranding by Fallon.
- The IRC manifesto emphasizes the goal of sustainable water, sanitation, and hygiene solutions.
- Innovative collaboration and long-term solutions are highlighted as key principles of IRC's identity.
