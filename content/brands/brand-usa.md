...
- Two-color versions of palettes 1, 5, 6, 7, 9 and 10 exist for printing situations where the number of available inks is limited by production methods. These color palettes should be used only for those scenarios. They should not be used in place of three-color palettes when three­color palettes are able to be printed.
