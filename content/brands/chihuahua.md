...
slug: chihuahua
description: ""
date: "2026-03-05T22:38:39.372197"
draft: false
sectors:
  - "public-sector"
  - tourism
...
- Clear space requirements defined as 2 units around the logo.
- Examples of correct and incorrect applications of the logo on dark backgrounds and other surfaces including reliefs using monochrome and reversed versions.
- Do's and don'ts of logo usage, including restrictions on altering elements, changing proportions, colors, applying effects, and rotating.
- Guidance for using the logo with other official logos or secretariat logos in proportion and spacing.
- Usage of monochrome logo versions in grayscale, black or negative, relevant for institutional applications.

**Color Information:**

- Official Pantone and color guides for brand and secretariat logos, including RGB, CMYK combinations for each Pantone, such as Pantone 541 C and Cool Grey 11 U.
- Special application of colors for TV, web, and digital media.
- Vinyl specifications for branding applications using Oracal 651 colors (e.g., Light blue, Traffic blue).

**Typography Information:**

- Use of Gotham font family in weights like Medium, Bold, and Book for various roles including official documents, stationery, and digital signatures.
- Font specifications for digital and stationery, such as size (e.g., 9 pt for Gotham Book) and color (e.g., Black at 70%).

**Spacing Layout:**

- Reticula and spacing for logo protection at '2 units'.
- Guidance for spacing and alignment of logos when combined with governmental or secretariat emblems.

**Notes:**

- Designs for stationery such as letterheads, envelopes, and folders provide customizable sections for decentralized organisms and detailed dimensions and formats.
- Special folder designs for Manila and Kangaroo formats include monochrome logo applications.
