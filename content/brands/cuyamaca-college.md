...
description: ""
date: "2026-04-10T09:40:32.543581"
draft: false
sectors:
  - education
regions:
...
- The visual identity centers on a stylized logo featuring a mountain range and crescent moons within an arched frame, using a serif font for the college name. The color palette includes navy blue, tan, black, and white. The guidelines emphasize clarity, professionalism, and consistency in logo usage, typeface, and color application [^1].

#### Categories

##### Logo Usage

- This is the only approved logo for Cuyamaca College academic, administrative, and business offices.
- Clear Space: 1/3 x margin on all sides, where x = Logo(size).
- Minimum Size: 5/16" width for the arch at the top, 5/8" height for the graphic, 3/4" width for the text across the bottom.
- The color, typeface and proportions should not vary. The identity must not be rotated, outlined, distorted, or have any additional effects added. The background should not distract from the identity. The relationship between the logo and the typographic signature must not vary.
- Colors: Blue CMYK: C100 M96 Y36 K32 RGB: R31 G36 B84 HEX: #1F2454; Tan CMYK: C5 M1 Y18 K0 RGB: R240 G243 B214 HEX: #F0F3D6; Black CMYK: C75 M68 Y67 K90 RGB: R0 G0 B0 HEX: #000000; White CMYK: C0 M0 Y0 K0 RGB: R255 G255 B255 HEX: #FFFFFF.

##### Color Palette

- Blue CMYK: C100 M96 Y36 K32 RGB: R31 G36 B84 HEX: #1F2454
- Tan CMYK: C5 M1 Y18 K0 RGB: R240 G243 B214 HEX: #F0F3D6
- Black CMYK: C75 M68 Y67 K90 RGB: R0 G0 B0 HEX: #000000
- White CMYK: C0 M0 Y0 K0 RGB: R255 G255 B255 HEX: #FFFFFF
- The color, typeface and proportions should not vary.
- The identity must not be rotated, outlined, distorted, or have any additional effects added.
- The background should not distract from the identity.
- The relationship between the logo and the typographic signature must not vary.

##### Typography

- Typeface: Scala Font Family
- abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUV 0123456789!@£$%°&
- Typeface: Scala Sans Font Family
- abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUV 0123456789!@£$%A&
- The color, typeface and proportions should not vary. The identity must not be rotated, outlined, distorted, or have any additional effects added. The background should not distract from the identity. The relationship between the logo and the typographic signature must not vary.
...
- This is the only approved logo for Cuyamaca College academic, administrative, and business offices.
- Primary Logo
- Reverse Primary Logo
- Secondary Logo
- Reverse Secondary Logo
- Clear Space: 1/3 x on all sides, where x = Logo(size)
- Minimum Size: 5/16" width for arch at top, 5/8" height for graphic, 3/4" width for text across the bottom
- Typeface: Scala Font Family
- Typeface: Scala Sans Font Family
- Colors: Blue CMYK: C100 M96 Y36 K32 RGB: R31 G36 B84 HEX: #1F2454; Tan CMYK: C5 M1 Y18 K0 RGB: R240 G243 B214 HEX: #F0F3D6; Black CMYK: C75 M68 Y67 K90 RGB: R0 G0 B0 HEX: #000000; White CMYK: C0 M0 Y0 K0 RGB: R255 G255 B255 HEX: #FFFFFF
- The color, typeface and proportions should not vary. The identity must not be rotated, outlined, distorted, or have any additional effects added. The background should not distract from the identity. The relationship between the logo and the typographic signature must not vary.
...
- Clear Space: 1/3 x margin on all sides of the logo, where x = Logo(size).
- Minimum Size: 5/16" width for the arch at the top, 5/8" height for the graphic, 3/4" width for the text across the bottom.
- The color, typeface and proportions should not vary. The identity must not be rotated, outlined, distorted, or have any additional effects added. The background should not distract from the identity. The relationship between the logo and the typographic signature must not vary.
