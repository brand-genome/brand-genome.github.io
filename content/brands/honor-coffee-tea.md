...
- 2. TRADE GOTHIC STD: CND No 18
- 3. TRADE GOTHIC STD: LIGHT / L.ITALIC
- 4. TRADE GOTHIC STD: REGLULAR / ITALIC
- 5. TRADE GOTHIC STD: BOLD No 2
- 6. TRADE GOTHIC STD: EXTENDED / BLD EXT
...
- This “H” icon must be uniform throughout all of its applications.
- The graphic integrity of the “H” and identity elements should be governed by the consistent use of established standards and observed in all communications with our vendors, affiliates, and the general public.
- Alterations to the “H” icon are prohibited.
- As with all Honor brandmarks and the “H” icon, the Honor logo lockups must retain these exact proportions and spatial relationships for all usages.
