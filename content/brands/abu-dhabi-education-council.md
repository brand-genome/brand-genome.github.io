...
Brand Logo and Elements
1.2
 
Iqraa
1.3
 
Implemented rules for logo usage
1.4
...
8.0   Brand Guidelines for Schools
9.0   Colour Swatches
...
which falls directly beneath it.
...
Placement on solid coloured backgrounds: 
...
ADEC Schools Logo Placement
8.3
 
ADEC Schools Businesscard
8.4
 
ADEC Schools Letterhead
8.5
 
ADEC Schools Envelopes
Contents
- ADEC BRAND IDENTITY GUIDELINES
2010
...
image and logo clash with each other.
...
- Some sections (e.g., Imagery, Spacing, Brand Voice) were not explicitly referenced in the PDF content.
