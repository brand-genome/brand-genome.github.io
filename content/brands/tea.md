...
- Komu B does not have any lowercase characters, so it should be used to denote departments and sports in places like letterheads and facility signage, or as a large attention­grabbing headline in graphics. It should not be used for large bodies of text.
