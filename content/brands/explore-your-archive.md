...
description: ""
date: "2026-04-10T09:40:34.669756"
draft: false
sectors:
  - ngo
  - "arts-culture"
...
- [https://www.exploreyourarchive.org](https://www.exploreyourarchive.org)
- [http://www.exploreyourarchive.org](http://www.exploreyourarchive.org)
...
- To ensure the campaign identity is given enough space, use the height of the ‘I’ in ARCHIVE to create an invisible boundary as shown above.
- The campaign identity has been designed as a fixed object and should be only be used as supplied.
- Consideration must be taken when using the identity to ensure it is reproduced correctly.
- The campaign identity is available in the following file formats and will be available to download. Formats EPS — print materials PNG— online/digital content
