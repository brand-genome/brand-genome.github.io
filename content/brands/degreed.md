...
- Always use True Blue, Sky's the Limit, Gold Medal, and Fry Sauce (in that order) on a four­color stripe. Or remove Sky's the Limit if a three-color combo is preferred.
...
- It is possible to use a fun aesthetic to com­municate serious topics as long as the integrity of your message isn't lost in unnecessary or unclear design.
