...
typographies: []
imagery_styles: []
wikidata_description: "nonprofit organization in London, United Kingdom"
wikidata_url: "https://www.wikidata.org/wiki/Q77084221"
has_twitter: false
has_guidelines: true
...
- Health Data Research UK is the national institute for health data science, uniting the UK’s health data to enable discoveries that improve people’s lives. The vision is that every health and care interaction and research endeavour will be enhanced by access to large scale data and advanced analytics [^1].
...
- A clearance zone equal to the ‘H’ from the logo should be adhered to, with no text or distracting visual elements entering this area.
...
| Property | Value |
|----------|-------|
| Wikidata Link | [Open Wikidata](https://www.wikidata.org/wiki/Q77084221) |
