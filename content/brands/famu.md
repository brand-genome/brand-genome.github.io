...
The copyright law of the United States (Title 17 U.S. Code) governs the making of photocopies or other productions of copyrighted material. The person reproducing the material is liable for infringement.
- THE SEAL
...
The presence of the seal authenticates publications as an official document from Florida A&M University. The Office of Communications must approve the use of the University’s logos and seal at all times. Manipulated, edited or altered versions of the seal are unlawful.

THE BLOCK LOGO MARK & IDENTITY SYSTEM

This is the signature/general block logo that is the official representative logo of the University.

UNIT/GENERAL BLOCK LOGOS
...
Myriad Pro is the primary sans serif font.
Times New Roman and Cambria the primary serif fonts.
Gill Sans Light/Century Gothic used when primary unavailable.
...
- PHOTOGRAPHY AND VISUAL GUIDELINES
Dynamic images preferred.
Show activity and mutual collaboration.
For landmark visuals, ensure presence of persons.

**Spacing Layout:**

- PUBLICATION guidelines also outline:
Maintaining clean brands/ed logo layouts within university space contributions.

**Brand Voice:**

- Editorial Brand Guidelines maintain citations within university approvals.
- Editorial Style Guide on Minor-specific suggestions tracks framework history.
