...
- countermeasure
- cross section (n.)-cross-section (v.) cross-communicate, cross-connect, cross-correlate, cross­cultural, cross-functional, cross-reference, cross-training cryptocurrency, cryptojacking, cryptomining cyber awareness cyber crime (n.)-cyber-crime (adj.) cyber criminal (n.)-cyber-criminal (adj.) cyber fraud cyber hygiene cyber program cyber risk cyber threat (n.)-cyber-threat (adj.) cyber warfare (n.)-cyber-warfare (adj.) cyberattack
