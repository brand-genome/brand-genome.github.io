...
slug: hexonet
description: ""
date: "2026-04-15T09:21:25.635220"
draft: false
sectors:
  - networking
  - software
...
- HEXONET’s identity is designed to inspire trust and security, with a bold, strong, and confident logo that captures the history and current thinking of the brand [^1].
...
- Greyscale logo Black logo Scale: 100% Size: 3”
...
- Colour: White (paper) Scale: 100% Size: 3”
...
- Do not flip or change the colour of the “X” in our logo in any way.
- Do not create, retype or redraw our logo.
- Do not rotate or flip our logo.
- Do not outline our logo.
- Our logo is restricted to 1” for print and 72px for digital applications.
...
- The core elements make the HEXONET brand instantly recognizable. They create the basis for the visual indentity. These elements consists of: • Logo • Colour palette • Typeface
- Gotham Medium Gotham Book Gotham Light
- The preferred way to use our logo is over white or light background with the colour logo as shown here.
- Colour logo Scale: 100% Size: 3”
- Greyscale logo Black logo Scale: 100% Size: 3”
...
- Print 0.15” 1”
- Digital 11PX 72PX
- Our logo needs to been seen and understood as quickly as possible wherever it appears. Maintaining a clearspace around the the “X” is a way to ensure this. Clear space is an area that is kept free from other text, graphic elements, or other visuals distractions.
...
- Colour “X” Scale: 100% Size: 1”
- Please observe these rules when placing our “X”.
- This “X” usage is only valid if a proof is provided to the HEXONET Creative Designer for approval.
- Do not ignore our “X”’s clear space, the “X” should not be positioned on the edge.
- Do not use the “X” near with our logo.
- Do not flip the “X” in our logo in any way.
- Do not rotate our “X”.
- Do not apply graphic effects such as drop shadows on our “X”.
- Do not distort or stretch our “X” in any way.
- Do not create, retype or redraw our “X”.
- Do not outline our “X”.
- Our “X” is restricted to 1” for print and 72px for digital applications.
- Print 0.15” .22”
- Digital 11PX 16PX
- Typography is a key element to communicate a unified personality for our brand. We have selected Gotham as our typeface.
- Gotham is strong, yet not overbearing. When writing headlines use Gotham in caps along with the weight of medium. When using Gotham for body copy, use sentence case. Mixing weights in headlines is fine.
