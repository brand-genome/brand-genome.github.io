...
slug: ncaa
description: ""
date: "2026-04-10T09:40:32.585943"
draft: false
sectors:
  - sports
regions:
...
- Use the cap height of "N" to measure distance between disk, dividing rule and entity mark. ◄• APPROVED Height of entity logo should not exceed the height of the ENTITY disk unless the design has LOGO an element that extends the mass of the logo. 1◄·c._ ◄• ___._,._ I = 3x I = 1x 20% black EXAMPLE: 1◄•••• 0 sPoRT science INSTITUTE*
- Do not use the enhanced disk.
- Do not skew, tilt or change the proportions of the disk.
- Do not change the disk's color.
- Do not place the disk on a low-contrast background.
...
##### Trademark And Legal Guidelines
