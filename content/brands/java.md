...
| Property | Value |
|----------|-------|
| Wikidata Link | [Open Wikidata](https://www.wikidata.org/wiki/Q193321) |

| Property | Value |
|----------|-------|
| Topic'S Main Category | Category:Java virtual machine |
| Freebase Id | /m/045rk |
| Stack Exchange Tag | https://stackoverflow.com/tags/jvm |
| Quora Topic Id | Java-Virtual-Machine, Java-Virtual-Machine-JVM |
| Babelnet Id | 00875176n |
| Used By | Java, Clojure, Apache Groovy, JRuby, Jython (+2 more) |
| Kbpedia Id | JavaVirtualMachine |
| Subclass Of | run-time system |
| Techopedia Id | 3376 |
| Zhihu Topic Id | 19566470 |
| Developer | Sun Microsystems |
| Sciencedirect Topic Id | computer-science/java-virtual-machines |
| Niconicopedia Id | java仮想マシン |
| Steamdb Tech Id | JVM |
| Nlai Id | 1524252 |
